...
for word_tags in word_tags_list:
     ...
     labels_encoding = list(labels) #inicialmente label sera toda zerada
     tag = word_tags[1] #salve a tag
     tag_index = classes.index(tag) #va para o inicio da tag
     labels_encoding[tag_index] = 1 #anexe 1 aquele indice
